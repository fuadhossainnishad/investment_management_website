...
export default function Index() {
  return (
    <div className="min-h-screen bg-neutral-bg">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-neutral-bg px-6 pb-[297px] md:px-12">
        {/* Background Chart */}
        <div className="pointer-events-none absolute inset-x-0 top-0 h-[784px] bg-gradient-to-b from-neutral-bg/70 via-[#D8DEF3]/70 to-neutral-bg/70">
          <div className="relative mx-auto h-full max-w-[1440px] opacity-50">
            {/* Grid Lines */}
            <svg
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="relative mx-auto h-full max-w-[1440px]">
            {/* Cap table badge */}
            <div className="absolute left-[262px] top-[301px] hidden rotate-[12deg] rounded-xl border border-neutral-border bg-white px-4 py-2 shadow-card lg:flex lg:items-center lg:gap-2">
            ...
            {/* Exit diagram badge */}
            <div className="absolute left-[672px] top-[7px] hidden -rotate-[15deg] rounded-xl border border-neutral-border bg-white px-4 py-2 shadow-card lg:flex lg:items-center lg:gap-2">
            ...
            <div className="absolute left-[89px] top-[59px] hidden -rotate-[14deg] rounded-xl border border-neutral-border bg-white px-4 py-2 shadow-card lg:flex lg:items-center lg:gap-2">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path
            ...
            <div className="absolute left-[731px] top-[78px] hidden rotate-[6deg] rounded-xl border border-neutral-border bg-white px-4 py-2 shadow-card lg:flex lg:items-center lg:gap-2">
        ...
        {/* Hero Content */}
        <div className="relative z-10 mx-auto max-w-[1248px] pt-[74px]">
          <div className="mb-24 flex flex-col items-center gap-24">
            <h1 className="max-w-[886px] text-center text-4xl font-bold leading-[120%] tracking-[-0.02em] text-neutral-text md:text-5xl">
              Simulate and manage investment rounds with precision and ease
            </h1>
            <button className="gradient-brand shadow-brand rounded-[32px] border border-brand-blue-border px-6 py-3 text-xl font-medium leading-6 text-neutral-bg transition-transform hover:scale-105">
      ...
      <section className="bg-neutral-bg px-6 py-20 md:px-12">
        <div className="mx-auto max-w-[1440px]">
          <div className="flex flex-col items-start gap-14 md:flex-row md:gap-14">
            {/* Left Content */}
            <div className="flex flex-1 flex-col gap-16">
              <div className="flex flex-col gap-6">
                ...
                <h2 className="max-w-[506px] text-4xl font-bold leading-[52px] tracking-[-0.02em] text-neutral-text md:text-5xl">
                  Understand the real impact of investment structures accounting
                  for all the details in a Term Sheet
                </h2>
              </div>
              <p className="text-2xl font-normal leading-8 tracking-[-0.005em] text-neutral-text opacity-70">
            ...
            <div className="flex h-[480px] w-full items-center justify-center overflow-hidden rounded-2xl bg-white md:w-auto">
      ...
      <section id="features" className="bg-neutral-bg px-6 py-20 md:px-12">
        <div className="mx-auto max-w-[1440px]">
          <h2 className="mb-12 text-center text-4xl font-bold leading-[52px] tracking-[-0.02em] text-neutral-text md:text-5xl">
            Key Features
          </h2>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6 lg:flex-row">
              ...
              <div className="flex min-h-[480px] flex-1 flex-col overflow-hidden rounded-2xl bg-neutral-bg-card pt-8">
                <div className="flex flex-col gap-2 px-8 pb-8">
                  <h3 className="text-[28px] font-bold leading-8 tracking-[-0.02em] text-neutral-text">
                    Advanced Simulations
                  </h3>
                  <p className="text-xl font-normal leading-6 tracking-[-0.005em] text-neutral-text opacity-70">
                    Understand dilution and effective ownership under different
                    exit scenarios
                  </p>
                </div>
                <div className="flex flex-1 items-center justify-center bg-gradient-to-br from-white/50 to-transparent p-8">
              ...
              {/* Clear Projections */}
              <div className="flex w-full flex-col overflow-hidden rounded-2xl bg-neutral-bg-card pt-8 lg:w-[480px]">
                ...
                <div className="mt-8 flex flex-1 items-center justify-center p-8">
                  <div className="flex flex-col items-center gap-10 rounded-[21px] bg-white px-4 py-6 shadow-[0_4px_32px_0_rgba(28,59,157,0.15)]">
            ...
            <div className="flex flex-col gap-6 lg:flex-row">
              ...
              <div className="flex w-full flex-col overflow-hidden rounded-2xl bg-neutral-bg-card pt-8 lg:w-[480px]">
                ...
                <div className="mt-12 flex flex-1 flex-col gap-4 px-[61px] pb-12">
                  {["Common", "RP+C", "CP", "PCP", "PCPC"].map((type) => (
                    <div
                      key={type}
                      className="flex items-center gap-3 rounded-[18px] border border-brand-blue/20 bg-white px-6 py-3 shadow-[0_4px_17px_0_rgba(28,59,157,0.10)]"
                    >
                      <span className="text-center text-2xl font-medium leading-[120%] tracking-[-0.02em] text-neutral-text">
                        {type}
                      </span>
                    </div>
                  ))}
              ...
              <div className="flex min-h-[480px] flex-1 flex-col overflow-hidden rounded-2xl bg-neutral-bg-card pt-8">
                ...
                <div className="mt-12 flex flex-1 items-center justify-end overflow-hidden">
                  <img
                    ...
                    className="h-auto w-full max-w-[1158px]"
                  />
                </div>
              </div>
            </div>
      ...
      <section className="bg-neutral-bg px-6 py-20 md:px-12">
        <div className="mx-auto max-w-[1440px]">
          <div className="overflow-hidden rounded-[32px] border border-neutral-border bg-white">
            <div className="flex flex-col items-center gap-12 py-[82px] md:flex-row md:items-start md:gap-0 md:px-[89px]">
              {/* Illustration */}
              <div className="w-full max-w-[451px]">
                <img
                  src="https://api.builder.io/api/v1/image/assets/TEMP/8e009de748a8ad3b7a94b1d946de0afb4685f24b?width=902"
              ...
              {/* Content */}
              <div className="flex max-w-[575px] flex-col gap-12 px-6 md:px-0">
                <h2 className="max-w-[468px] text-4xl font-bold leading-[52px] tracking-[-0.02em] text-neutral-text md:text-5xl">
                  Built for the Venture Capital Ecosystem
                </h2>
                <p className="text-xl font-normal leading-6 tracking-[-0.005em] text-neutral-text opacity-80">
                ...
                <button className="gradient-brand shadow-brand self-start rounded-[32px] border border-brand-blue-border px-6 py-3 text-xl font-medium leading-6 text-neutral-bg transition-transform hover:scale-105">
                  Start free trial
                </button>
              </div>
            </div>
      ...
      <section id="contact" className="bg-neutral-bg px-6 py-20 md:px-12">
        <div className="mx-auto max-w-[1344px]">
          <div className="overflow-hidden rounded-[32px] border border-neutral-border bg-white shadow-[0_387px_108px_0_rgba(16,33,86,0.00),0_248px_99px_0_rgba(16,33,86,0.01),0_139px_84px_0_rgba(16,33,86,0.05),0_62px_62px_0_rgba(16,33,86,0.09),0_15px_34px_0_rgba(16,33,86,0.10)]">
            <div className="flex flex-col items-center gap-12 px-6 py-12 md:px-12">
              {/* Header */}
              <div className="flex max-w-[700px] flex-col gap-4">
                <h2 className="text-center text-4xl font-bold leading-[52px] tracking-[-0.02em] text-neutral-text md:text-5xl">
                  Get in Touch
                </h2>
                <p className="text-center text-2xl font-normal leading-8 tracking-[-0.005em] text-neutral-text opacity-70">
              ...
              {/* Form */}
              <form className="flex w-full max-w-[700px] flex-col gap-4">
                <div className="flex flex-col gap-4 md:flex-row">
                  <input
                    type="text"
                    placeholder="First name"
                    className="min-h-[44px] flex-1 rounded-lg bg-neutral-bg-input px-3 py-3 text-[15px] font-normal leading-5 text-neutral-text placeholder:opacity-50 focus:outline-none focus:ring-2 focus:ring-brand-blue"
                  />
                  <input
                    type="text"
                ...
                <input
                  type="email"
                  placeholder="Email"
                  className="min-h-[44px] w-full rounded-lg bg-neutral-bg-input px-3 py-3 text-[15px] font-normal leading-5 text-neutral-text placeholder:opacity-50 focus:outline-none focus:ring-2 focus:ring-brand-blue"
                />
                <textarea
                  placeholder="Message"
                  rows={5}
                  className="min-h-[124px] w-full rounded-lg bg-neutral-bg-input px-3 py-3 text-[15px] font-normal leading-5 text-neutral-text placeholder:opacity-50 focus:outline-none focus:ring-2 focus:ring-brand-blue"
                />
                <button
                  type="submit"
                  className="gradient-brand shadow-brand self-start rounded-[32px] border border-brand-blue-border px-6 py-3 text-[15px] font-medium leading-5 text-white transition-transform hover:scale-105"
                >
                  Submit
                </button>
              </form>
