...
import InvestmentsSimulationCard, { InvestmentsSimulationCardProps } from './_components/InvestmentsSimulationCard';

const SavedsimulationData: InvestmentsSimulationCardProps[] = [
    {
        title: "Real-Time Data Analysis",
        desc: "Projecting the necessary investment and its valuation in 5 years",
        scenario: 4
    },
    {
        title: "Real-Time Data Analysis",
...
export default function HolePage() {
    return (
        <main className='space-y-10'>
            ...
            <section className='space-y-4'>
                <section className='flex w-full justify-between items-center h-fit '>
                    <div className='text-lg font-semibold'>Saved Simulation</div>
                    <div className='flex gap-2 items-center rounded-2xl bg-[#2D60FF] w-fit  px-3 py-2'>
                        <Image
                            src='/icons/create.svg'
                            alt='nav'
