...
export default function Page() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center bg-[#F5F6FA] overflow-hidden">
      {/* Left Column - Form */}
      <div className="flex-1 flex flex-col items-center justify-center gap-10 lg:gap-20">
        {/* Logo */}
        ...
        {/* Form */}
        <form onSubmit={handleLogin} className="flex flex-col gap-8 w-1/2">
          {/* Title */}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex justify-between items-start">
                <button
                  type="button"
                  className="font-roboto text-[10px] font-normal text-[#0C2A92] hover:underline"
                >
                  Forgot password
                </button>
          ...
          <button
            type="submit"
            className="w-full py-3 px-6 rounded-4xl border border-[#2648B5] font-roboto text-sm font-medium text-[#F5F6FA] transition-all hover:opacity-90"
            style={{
              background:
          ...
          <div className="text-center font-roboto text-sm font-normal">
            ...
            <Link href="/signUp" className="text-[#0F3DDE] hover:underline">
              Sign Up
            </Link>
          </div>
        </form>
